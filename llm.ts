...
const llm = async ({
  ...
  let prompt = `This is a choose your own adventure story called ${title} with a theme of ${theme} and a setting of ${setting} from the perspective of a singular character.  There are ${maxTurns} turns in this story.  We are currently on turn ${currTurns}.  Use this as context for the next stage of the story have been: ${JSON.stringify(
    history
